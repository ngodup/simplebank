...
// Source: github.com/ngodup/simplebank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) ListAllEntries(ctx context.Context, arg db.ListAllEntriesParams) ([]db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAllEntries", ctx, arg)
	ret0, _ := ret[0].([]db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) ListAllEntries(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAllEntries", reflect.TypeOf((*MockStore)(nil).ListAllEntries), ctx, arg)
}

// ListAllTransfers mocks base method.
func (m *MockStore) ListAllTransfers(ctx context.Context, arg db.ListAllTransfersParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAllTransfers", ctx, arg)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) ListAllTransfers(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAllTransfers", reflect.TypeOf((*MockStore)(nil).ListAllTransfers), ctx, arg)
}
...
func (m *MockStore) ListTransfersFrom(ctx context.Context, arg db.ListTransfersFromParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransfersFrom", ctx, arg)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) ListTransfersFrom(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransfersFrom", reflect.TypeOf((*MockStore)(nil).ListTransfersFrom), ctx, arg)
}

// ListTransfersTo mocks base method.
func (m *MockStore) ListTransfersTo(ctx context.Context, arg db.ListTransfersToParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransfersTo", ctx, arg)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) ListTransfersTo(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransfersTo", reflect.TypeOf((*MockStore)(nil).ListTransfersTo), ctx, arg)
}
